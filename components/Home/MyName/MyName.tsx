  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-AAsecondary">full-stack</span> applications.{" "}
        <br className="2xl:block hidden" />I have a strong understanding of the
        full software development life cycle, from creating and deploying them,
        as well as implementing the front-end components to enable seamless user
        interactions.
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
